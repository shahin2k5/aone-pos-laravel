...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?php echo e(route('user.products.update', $product)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
             ...
             <div class="form-group">
                <label for="price"><?php echo e(__('Purchase Price')); ?></label>
...
<?php echo $__env->make('user.layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\user\products\edit.blade.php ENDPATH**/ ?>