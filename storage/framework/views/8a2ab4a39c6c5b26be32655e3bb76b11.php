            ...
            <div class="card-body">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-settings-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Home</a>
                        <a class="nav-item nav-link" id="nav-user-list-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">User list</a>
                        <a class="nav-item nav-link" id="nav-branch-list-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Branch List</a>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane border fade show active p-5" id="nav-settings" role="tabpanel" aria-labelledby="nav-home-tab">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="tab-pane fade" id="nav-user-list" role="tabpanel" aria-labelledby="nav-profile-tab">
                           <form action="<?php echo e(route('settings.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="tab-pane fade" id="nav-branch-list" role="tabpanel" aria-labelledby="nav-contact-tab">
                           <form action="<?php echo e(route('settings.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
