        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($supplier->balance ?? 0, 2)); ?></td>
                    ...
                    <td>
                        ...
                        <a href="<?php echo e(route('admin.suppliers.pay', $supplier)); ?>" class="btn btn-success">Pay</a>
