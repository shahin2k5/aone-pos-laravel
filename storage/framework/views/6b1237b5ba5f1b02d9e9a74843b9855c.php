...
<?php $__env->startSection('content-header', '['.auth()->user()->first_name.'] User Dashboard - '. now()); ?>
   ...
   <div class="row">
      ...
      <div class="col-lg-3 col-6">
         ...
         <div class="small-box bg-warning">
            ...
            <a href="<?php echo e(route('user.customers.index')); ?>" class="small-box-footer"><?php echo e(__('common.More_info')); ?> <i class="fas fa-arrow-circle-right"></i></a>
         </div>
      </div>
      <!-- ./col -->
   </div>
...
<?php echo $__env->make('user.layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\user\dashboard.blade.php ENDPATH**/ ?>