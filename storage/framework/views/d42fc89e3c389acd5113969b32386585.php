...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <form method="GET" action="<?php echo e(route('admin.expense.sales-details')); ?>" class="form-inline">
                ...
                <a href="<?php echo e(route('admin.expense.sales-details')); ?>" class="btn btn-secondary">Reset</a>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="small">
                                        <?php echo e($item->product ? $item->product->name : 'Product Deleted'); ?> x <?php echo e($item->quantity); ?> = <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($item->sell_price, 2)); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/senpai/Work/laravel/aone-pos-laravel/resources/views/admin/expense/sales-details.blade.php ENDPATH**/ ?>