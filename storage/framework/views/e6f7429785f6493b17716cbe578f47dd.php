...
<a href="<?php echo e(route('salesreturns.index')); ?>" class="btn btn-primary"><?php echo e(__('+ Salesreturn')); ?></a>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $salesreturns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesreturn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td> <?php echo e($salesreturn->id); ?></td>
                    <td><?php echo e($salesreturn->getCustomerName()); ?></td>
                    <td><?php echo e($salesreturn->order_id); ?></td>
                    <td><?php echo e(number_format($salesreturn->total_qnty)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($salesreturn->total_amount)); ?></td>
        ...
        <div class="text-center"><?php echo e($salesreturns->render()); ?></div>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\admin\salesreturn\index.blade.php ENDPATH**/ ?>