<?php $__env->startSection('title', __('Purchase Details')); ?>
<?php $__env->startSection('content-header', __('Purchase Details#'.$purchase->id)); ?>
<?php $__env->startSection('content-actions'); ?>
<a href="/admin/purchase" class="btn btn-primary"><?php echo e(__('<< Purchases')); ?></a>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?php if($purchase): ?>
            <div class="row">
                <div class="col-md-4"><b>Invoice no: </b> <?php echo e($purchase->invoice_no); ?></div>
                <div class="col-md-4"><b>Supplier: </b> <?php echo e($purchase->supplier?$purchase->supplier->first_name:''); ?></div>
                <div class="col-md-4"><b>Sub Total:</b> <?php echo e(number_format($purchase->sub_total,0)); ?></div>
                <div class="col-md-4"><b>Discount:</b> <?php echo e($purchase->discount_amount); ?></div>
                <div class="col-md-4"><b>Gr. Amount:</b> <?php echo e($purchase->gr_total); ?></div>
                <div class="col-md-4"><b>Paid Amount:</b> <?php echo e($purchase->paid_amount); ?></div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e('Branch'); ?></th>
                    <th><?php echo e('Purchase Rate'); ?></th>
            ...
            <tbody>
                <?php if($purchase && $purchase->items): ?>
                <?php $__currentLoopData = $purchase->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($loop->index+1); ?></td>
                    <td>
                        <img class="product-img" src="<?php echo e($purchase_item->product ? $purchase_item->product->image_url : asset('images/img-placeholder.jpg')); ?>" alt="" style="width:55px;height:55px">
                        <?php echo e($purchase_item->product->name ?? '-'); ?>

                    </td>
                    <td><?php echo e($purchase_item->branch ? $purchase_item->branch->branch_name : '-'); ?></td>
                    <td><?php echo e(number_format($purchase_item->purchase_price, 2)); ?></td>
                    <td><?php echo e(number_format($purchase_item->quantity, 0)); ?></td>
                    <td><?php echo e(number_format($purchase_item->purchase_price * $purchase_item->quantity, 2)); ?></td>
                    <td><?php echo e($purchase_item->created_at); ?></td>
                </tr>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/senpai/Work/laravel/aone-pos-laravel/resources/views/admin/purchase/details.blade.php ENDPATH**/ ?>