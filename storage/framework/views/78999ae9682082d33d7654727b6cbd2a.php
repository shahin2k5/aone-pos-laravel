...
<?php $__env->startSection('content-header', __('Purchase Return')); ?>
<?php $__env->startSection('content-actions'); ?>
<a href="<?php echo e(route('admin.purchasereturns.index')); ?>" class="btn btn-primary"><?php echo e(__('+ Purchase Return')); ?></a>
    ...
    <div class="card-body">
            ...
            <div class="col-md-6">
                <form action="<?php echo e(route('admin.salesreturns.index')); ?>">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button class="btn btn-outline-primary" type="submit"><?php echo e(__('Purchase Return')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    <th><?php echo e('ID'); ?></th>
                    <th><?php echo e('Suppplier'); ?></th>
                    <th><?php echo e('Invoice'); ?></th>
                    <th><?php echo e('Return Quantity'); ?></th>
                    <th><?php echo e('Return Total'); ?></th>
                    <th><?php echo e('Return'); ?></th>
                    <th><?php echo e('Profit'); ?></th>
                    <th><?php echo e('Created'); ?></th>

                </tr>
            </thead>
            <tbody>
                <?php $__currentLoopData = $purchase_returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td> <?php echo e($purchase->id); ?></td>
                    <td><?php echo e($purchase->supplier ? $purchase->supplier->first_name . ' ' . $purchase->supplier->last_name : ''); ?></td>
                    <td><?php echo e($purchase->purchase ? $purchase->purchase->invoice_no : ''); ?></td>
                    <td><?php echo e(number_format($purchase->total_qnty)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->total_amount)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->return_amount)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->profit_amount)); ?></td>
                    <td><?php echo e($purchase->created_at); ?></td>
                    <td><a href="/admin/purchasereturn/details/<?php echo e($purchase->id); ?>" class="btn btn-success"><i class="fa fa-eye"></i></a></td>
        ...
        <div class="text-center"><?php echo e($purchase_returns->render()); ?></div>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views/admin/purchasereturn/index.blade.php ENDPATH**/ ?>