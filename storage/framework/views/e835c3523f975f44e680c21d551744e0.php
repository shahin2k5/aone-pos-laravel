...
<?php $__env->startSection('content-header', 'Expense Details Report'); ?>
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <form method="GET" action="<?php echo e(route('admin.expense.expense-details')); ?>" class="form-inline">
                ...
                <a href="<?php echo e(route('admin.expense.expense-details')); ?>" class="btn btn-secondary">Reset</a>
            </form>
        </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($expense->created_at->format('M d, Y H:i')); ?></td>
                            <td><?php echo e($expense->expense_head); ?></td>
                            <td><?php echo e($expense->expense_description); ?></td>
                            <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($expense->expense_amount, 2)); ?></td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\admin\expense\expense-details.blade.php ENDPATH**/ ?>