...
<a href="<?php echo e(route('expense.create')); ?>" class="btn btn-primary"><i class="fa fa-chevron-left"></i> Add Expenses</a>
    ...
    <div class="col-sm-8">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('expense.head.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\admin\expense\create-head.blade.php ENDPATH**/ ?>