            ...
            <div class="tab-pane fade show active" id="report" role="tabpanel" aria-labelledby="report-tab">
                <div class="report-summary-area p-3" style="background: #f8f9fa; border-radius: 8px;">
                    ...
                    <div class="report-cards-row">
                        ...
                        <div class="report-card mb-3">
                            <a href="<?php echo e(route('user.expense.damage-details')); ?>" class="text-decoration-none">
                                <div class="card shadow-sm border-0 text-center h-100">
                                    <div class="card-body d-flex flex-column justify-content-center" style="min-height: 150px;">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="expense_head" id="expense_head">
                                            ...
                                            <?php $__currentLoopData = $expense_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value='<?php echo e($exp->expense_head); ?>' <?php echo e(request('expense_head') == $exp->expense_head ? 'selected' : ''); ?>>
                                                    <?php echo e($exp->expense_head); ?>
...
<?php echo $__env->make('user.layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\user\expense\index.blade.php ENDPATH**/ ?>