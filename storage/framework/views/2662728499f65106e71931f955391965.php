...
<a href="<?php echo e(route('admin.cart.index')); ?>" class="btn btn-primary"> <i class="nav-icon fas fa-cart-plus"></i> <?php echo e(__('POS')); ?></a>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-5">
                <form action="<?php echo e(route('admin.sales.index')); ?>">
                    <div class="row">
                        <div class="col-md-5">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="partialPaymentForm" method="POST" action="<?php echo e(route('admin.sales.partial-payment')); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views/admin/sales/index.blade.php ENDPATH**/ ?>