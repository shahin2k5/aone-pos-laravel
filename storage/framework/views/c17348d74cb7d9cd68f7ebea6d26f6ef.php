...
<?php $__env->startSection('content-header', __('Purchase')); ?>
<?php $__env->startSection('content-actions'); ?>
<a href="<?php echo e(route('admin.purchases.create')); ?>" class="btn btn-primary"><?php echo e(__('New Purchase')); ?></a>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="<?php echo e(route('admin.purchase.index')); ?>">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <button class="btn btn-outline-primary" type="submit"><?php echo e(__('Purchase submit')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($purchase->supplier?$purchase->supplier->first_name:""); ?></td>
                    <td><?php echo e($purchase->invoice_no); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->sub_total)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->discount_amount)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->gr_total)); ?></td>
                    <td><?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->paid_amount)); ?></td>
                    <td><?php echo e($purchase->created_at); ?></td>
                    <td><a href="/admin/purchase/details/<?php echo e($purchase->id); ?>" class="btn btn-success"><i class="fa fa-eye"></i></a></td>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-right"> <strong>Status:</strong> ${
                                ...
                                receivedAmount == 0?
                                    '<span class="badge badge-danger">salesreturn.Not_Paid</span>':
                                receivedAmount < totalAmount ?
                                    '<span class="badge badge-warning">salesreturn.Partial</span>':
                                receivedAmount == totalAmount?
                                    '<span class="badge badge-success">salesreturn.Paid</span>':
                                receivedAmount > totalAmount?
                                    '<span class="badge badge-info">salesreturn.Change</span>':''
                    }</span>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views/admin/purchase/index.blade.php ENDPATH**/ ?>