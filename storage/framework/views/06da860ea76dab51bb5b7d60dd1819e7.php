...
<a href="<?php echo e(route('cart.index')); ?>" class="btn btn-primary"> <i class="nav-icon fas fa-cart-plus"></i> <?php echo e(__('POS')); ?></a>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-5">
                <form action="<?php echo e(route('sales.index')); ?>">
                    <div class="row">
                        <div class="col-md-5">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="partialPaymentForm" method="POST" action="<?php echo e(route('sales.partial-payment')); ?>">
                                                <?php echo csrf_field(); ?>
