...
unset($__errorArgs, $__bag); ?>" id="sell_price"
                    placeholder="<?php echo e(__('product.Price')); ?>" value="<?php echo e(old('sell_price')); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="branch_stock[<?php echo e($branch->id); ?>]" class="form-control" min="0"
                                    value="<?php echo e(old('branch_stock.' . $branch->id, 0)); ?>">
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/senpai/Work/laravel/aone-pos-laravel/resources/views/admin/products/create.blade.php ENDPATH**/ ?>