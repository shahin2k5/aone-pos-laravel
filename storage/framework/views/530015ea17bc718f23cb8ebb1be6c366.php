   ...
   <div class="row">
      ...
      <div class="col-lg-3 col-6">
         ...
         <div class="small-box bg-success">
            ...
            <a href="<?php echo e(route('admin.purchases.index')); ?>" class="small-box-footer"><?php echo e(__('common.More_info')); ?> <i class="fas fa-arrow-circle-right"></i></a>
         </div>
      </div>
      <!-- ./col -->
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/senpai/Work/laravel/aone-pos-laravel/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>