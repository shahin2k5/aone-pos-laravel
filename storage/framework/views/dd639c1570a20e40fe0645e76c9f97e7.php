        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(number_format($purchase_item->qnty ?? $purchase_item->quantity,0)); ?></td>
                    <td><?php echo e(number_format($purchase_item->purchase_price * ($purchase_item->qnty ?? $purchase_item->quantity),2)); ?></td>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\admin\purchase\details.blade.php ENDPATH**/ ?>