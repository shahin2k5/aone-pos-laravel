...
<?php $__env->startSection('content-header', __('Purchase Details#'.$purchase_items[0]->id)); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="<?php echo e(route('salesreturns.index')); ?>">
        ...
        <?php if($purchase_items): ?>
            <div class="row">
                <div class="col-md-4"><b>Invoice no: </b> <?php echo e($purchase_items[0]->invoice_no); ?></div>
                <div class="col-md-4"><b>Supplier: </b> <?php echo e($purchase_items[0]->supplier?$purchase_items[0]->supplier->first_name:''); ?></div>
                <div class="col-md-4"><b>Sub Total:</b> <?php echo e(number_format($purchase_items[0]->sub_total,0)); ?></div>
                <div class="col-md-4"><b>Discount:</b> <?php echo e($purchase_items[0]->discount_amount); ?></div>
                <div class="col-md-4"><b>Gr. Amount:</b> <?php echo e($purchase_items[0]->gr_total); ?></div>
                <div class="col-md-4"><b>Paid Amount:</b> <?php echo e($purchase_items[0]->paid_amount); ?></div>
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $purchase_items[0]->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  
                    <td><?php echo e($loop->index+1); ?></td>
                    <td><img class="product-img" src="<?php echo e(Storage::url($purchase_item->product->image)); ?>" alt="" style="width:55px;height:55px"></td>
                    <td><?php echo e($purchase_item->product->name); ?></td>
                    <td><?php echo e(number_format($purchase_item->purchase_price,2)); ?></td>
                    <td><?php echo e(number_format($purchase_item->qnty,0)); ?></td>
                    <td><?php echo e(number_format($purchase_item->purchase_price * $purchase_item->qnty,2)); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\admin\purchase\details.blade.php ENDPATH**/ ?>