...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <form method="GET" action="<?php echo e(route('admin.expense.cash-details')); ?>" class="form-inline">
                ...
                <a href="<?php echo e(route('admin.expense.cash-details')); ?>" class="btn btn-secondary">Reset</a>
            </form>
        </div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Shahin Files + Live Projects\LIVE PROJECTS\aone-pos-laravel\aone.qoyelxyz.com\resources\views\admin\expense\cash-details.blade.php ENDPATH**/ ?>