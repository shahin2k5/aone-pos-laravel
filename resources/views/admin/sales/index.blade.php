...
<a href="{{route('admin.cart.index')}}" class="btn btn-primary"> <i class="nav-icon fas fa-cart-plus"></i> {{ __('POS') }}</a>
@endsection
@section('content')
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="partialPaymentForm" method="POST" action="{{ route('admin.sales.partial-payment') }}">
                                                @csrf
