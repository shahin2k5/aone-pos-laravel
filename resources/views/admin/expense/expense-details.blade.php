...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <form method="GET" action="{{ route('admin.expense.expense-details') }}" class="form-inline">
                ...
                <a href="{{ route('admin.expense.expense-details') }}" class="btn btn-secondary">Reset</a>
            </form>
        </div>
