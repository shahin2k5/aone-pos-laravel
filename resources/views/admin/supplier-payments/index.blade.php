...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <form method="GET" action="{{ route('admin.supplier-payments.index') }}" class="form-inline">
                    ...
                    <a href="{{ route('admin.supplier-payments.index') }}" class="btn btn-secondary">Reset</a>
                </form>
            </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.purchase.show', ['purchase' => $payment->purchase_id]) }}" class="btn btn-sm btn-info">
