...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <form method="GET" action="{{ route('user.expense.purchase-details') }}" class="form-inline">
                ...
                <a href="{{ route('user.expense.purchase-details') }}" class="btn btn-secondary">Reset</a>
            </form>
        </div>
